...
const Home = () => {
  ...
  return (
    <div className={"home"}>
      <SignUpUserType />
      <div className="steps-section student-steps-section">
        <h2 className="steps-section-title">Student Team</h2>
        <div className={"text-info-wrapper wrapper-one"}>
          <HomeSection
            title={"Student Team"}
        ...
        <div className={"text-info-wrapper wrapper-two"}>
          <ApplyProject />
          <HomeSection
      ...
      <h1>Why Us?</h1>
      <div className={"section-wrapper home-step-section"}>
